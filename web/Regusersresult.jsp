                    ...
                    <div class="col-lg-12">
                        <div class="intro-message"> 
                            ...
                            <div style="float:left; width:50%;">
                                ...
                                <div style="width:365px;height:150px;line-height:3em;overflow:scroll;padding:5px;">
                                    <%                                        while (rs.next()) {
                                ...
                                <div style="width:365px;height:150px;line-height:3em;overflow:scroll;padding:5px;">
                                    <%
                                        ...
                                        while (rs.next()) {
                                            ...
                                            sql = "select sid from upvote where user_id='" + rs.getString("user_id") + "' and sid=" + rs.getInt("sid");
                                            ResultSet rs1 = st.executeQuery(sql);
                                            out.println(rs.getString("user_id") + " : " + rs.getString("suggestions"));
                                            if (rs1.next()) {
                                                out.print("<span class=\"input-group-btn\"> <button class=\"btn btn-danger\" id=\"dec\" type=\"button\" value=\"" + rs.getInt("sid") + "\" onclick=\"decr();\"> <span class=\" glyphicon glyphicon-heart\"> </span></button></span><br/>");
                                            } else {
                                                out.print("<span class=\"input-group-btn\"> <button class=\"btn btn-danger\" type=\"button\" onclick=\"incr();\"> <span class=\" glyphicon glyphicon-heart-empty\"> </span></button></span><br/>");
                                            }
                                        }
                                    ...
                                    <script>
                                        function decr()
                                        {
                                            ...
                                            window.location = "http://localhost:8024/DownVote?sid="+x;
